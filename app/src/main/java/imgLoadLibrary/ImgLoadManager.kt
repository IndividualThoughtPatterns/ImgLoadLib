...
class ImgLoadManager private constructor() {
    ...
    private var threadPoolExecutor: ExecutorService = ThreadPoolExecutor(
        10,
        20,
        3000,
...
//                urlToImageSetterMap.remove(url);
    ...
    private fun getBitmapFromCacheOrDownload(url: String, imageViewRef: WeakReference<ImageView>) {
